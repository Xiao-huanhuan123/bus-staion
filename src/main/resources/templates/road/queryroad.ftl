					...
					handler: function()
						{
								$("#win").window({    
                                    ...
                                    top:0,
								    title:'添加公交线路',   
								    content:'<iframe frameborder="0" width="100%"   height="100%" padding="20px" src="send_road_saveroad.action"/>'
								});  
						}
					},'-',{
                    iconCls: 'icon-add',
...
<body>
 	...
 	<table id="dg" ></table>
 	<div id="win" data-options="collapsible:false,minimizable:false,maximizable:false,modal:true" shadow="false"></div>


    <div id="dlg" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px;top:20px"
         closed="true" shadow="false" buttons="#dlg-buttons">
