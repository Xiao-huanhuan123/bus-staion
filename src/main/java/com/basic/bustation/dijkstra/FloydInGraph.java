...
public class FloydInGraph {
     ...
     */
    public void initMap(List<Roadsection> roadsectionList, List<Roadstation> roadstationList, int type){
//        int size=roadsectionList.size()+1;
        int size=roadstationList.size();
    ...
    public int insertRoadsection(Roadstation roadstation){
        ...
        if(isSameId>=0){
            ...
            mutex=roadstations.size();///数组的size，懂的都懂
