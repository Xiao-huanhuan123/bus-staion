...
public class RoadlineController extends BaseController{
    ...
    private Logger log = LoggerFactory.getLogger(RoadlineController.class);
...
//		步骤2：搜索公交数据库，经过起始站点A的公交线路存为X(i)（i=1, 2, 3, ..., m, m为正整数) , 经过目的站点B的公交线路存为Y(j) ( j=1, 2, 3, ...f, n, n为正整数) 。 
