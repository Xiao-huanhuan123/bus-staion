...
public class FloydInGraphTest {
    ...
    public void testFindMIXDistance() throws Exception {
        ...
        graph.initMap(roadsectionDAO.findAll(), roadstationDAO.findAll(), 1);
        graph.findMIXDistance(roadstationDAO.getById(Long.valueOf(100)),roadstationDAO.getById(Long.valueOf(107)));
    }
}
